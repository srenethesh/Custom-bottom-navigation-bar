...
export default function App() {
  ...
  const renderTabBar = ({ state, descriptors, navigation }) => (
    <View style={styles.tabBar}>
      ...
      <Animated.View style={[styles.dot, { transform: [{ translateX: dotPosition.interpolate({ inputRange: [0, 1, 2], outputRange: [61, 190, 325] }) }] }]} />
    </View>
  );
...
const DummyScreen = () => <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} />;
